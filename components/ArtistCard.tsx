  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        />
        {/* Yellow/Gold tint on hover */}
        <div className="absolute inset-0 bg-black/40 group-hover:bg-[#FFD700]/20 transition-colors duration-500" />
      </div>
      ...
      <div className="absolute inset-0 p-6 md:p-8 flex flex-col justify-between pointer-events-none">
        ...
        <div>
          ...
          <motion.p 
            className="text-xs md:text-sm font-medium uppercase tracking-widest text-[#FFD700] mt-2 will-change-transform"
            variants={{
              rest: { opacity: 0, y: 10 },
              hover: { opacity: 1, y: 0 }
            }}
